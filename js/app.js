...
function q7Guess (){
  ...
  alert(`That was your last try. The original piggy names are ${namesOG}.`);
}
q7Guess();

alert(`Thank you for playing this guessing game with me, ${userName}! You got ${correctCount} out of 7 correct!`);
